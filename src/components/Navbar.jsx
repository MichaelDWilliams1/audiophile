...
if(toggleHamburgerMenu === 'visible'){
  ...
  return (
    <>
    <div className='flex md:h-24 bg-neutral-900 text-white'>
     <div className='lg:hidden md:mt-10 md:ml-20 mt-5 ml-5'><i onClick={toggleMenu} className="uil uil-bars md:hover:text-orange-600"></i></div>
    <Link to='/'><div className='flex h-1/2 border-2 ml-5 mt-5 w-auto md:mt-7  md:ml-10 lg:ml-32 text-2xl font-bold items-center hover:text-orange-600'>audiophile</div></Link>
        ...
        <i onClick={modalCartPopUpOpen} className="text-4xl mt-3 ml-3 md:ml-10 md:mt-7 md:mr-28 uil uil-shopping-cart relative hover:text-orange-600"><CartItemsCounter /></i>
