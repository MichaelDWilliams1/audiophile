...
<div className='h-82 flex md:items-center md:justify-center md:h-full'>
    <div className='background flex flex-col justify-around md:justify-around h-4/5 m-auto md:h-2/4 md:w-5/6 md:m-auto '>
       <section className='lg:ml-10 flex md:mr-16 md:justify-start w-full md:w-auto'>
        ...
        <section className='lg:ml-10 flex flex-col w-screen md:w-auto'>
