...
const SeeProductHomePage = () => {
  ...
  return (
    ...
    <section className='backgroundImage flex w-5/6 h-60 lg:h-3/6 lg:w-9/12  m-auto mt-12 rounded-xl'>
    ...
    <section className='flex flex-col md:flex-row space-y-4 md:space-y-0 lg:h-3/6 h-auto md:h-1/3 lg:w-9/12 w-5/6 m-auto mt-12 rounded-xl'>
      <div className='w-full md:w-3/6 h-60 md:h-auto mr-10 rounded-xl'>
      ...
      <div className='flex justify-center items-center h-60 md:h-auto w-full md:w-3/6 bg-stone-200 rounded-xl'>
