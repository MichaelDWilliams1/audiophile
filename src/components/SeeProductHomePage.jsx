...
const SeeProductHomePage = () => {
  ...
  return (
    ...
    <section  className='flex flex-col h-auto md:h-4/6 w-full'>
        <div className='backgroundSvg bg-orange-500 flex flex-col lg:flex-row  w-11/12 lg:w-9/12 h-full m-auto mt-0 rounded-xl'>
            ...
            <div className='flex h-full lg:w-3/6 w-full'>
                ...
                <Link to={`/item/${siteData[0]?.product[5].slug}`} className='w-2/4 lg:h-1/6'><button className='bg-black w-full lg:h-full h-16 mb-4 text-slate-100 hover:bg-zinc-800'>SEE PRODUCT</button></Link>
                </div>
            </div>
        </div>
    </section>
    <section className='backgroundImage flex w-11/12 h-80 lg:h-3/6 lg:w-9/12  m-auto mt-12 rounded-xl'>
        <div className='h-full lg:w-1/3 w-full md:w-1/2 flex flex-col justify-center items-end'>
            <div className='lg:w-3/4 w-full space-y-2 lg:h-2/6 h-2/5 flex flex-col items-center lg:items-start justify-between'>
                <p className='text-2xl md:text-3xl font-bold'>ZX7 SPEAKER</p>
    ...
    <section className='flex flex-col md:flex-row space-y-4 md:space-y-0 lg:h-3/6 h-auto w-11/12 lg:w-9/12 m-auto mt-12 rounded-xl'>
      <div className='w-full md:w-3/6 h-80 mr-10 rounded-xl'>
      ...
      <div className='flex justify-center items-center h-80 w-full md:w-3/6 bg-stone-200 rounded-xl'>
        <div className=' flex flex-col ml-4 justify-between md:h-2/5 md:w-5/6 w-full lg:items-start space-y-4 h-auto'>
