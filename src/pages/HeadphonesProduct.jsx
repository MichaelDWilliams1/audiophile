...
const navigate = useNavigate();
  ...
  return (
    ...
    <section className="h-fit mt-24 w-full">
        <div className="flex flex-col lg:flex-row w-11/12 lg:w-9/12 m-auto border-2 border-red-600">
            <div className="lg:w-1/2 h-1/2 lg:h-full">
                <img className="h-full w-full" src={siteData[0]?.product[3]?.image.desktop} />
            </div>
            <div className="flex justify-end items-center w-full lg:w-1/2 h-100 border-2">
        ...
        <div  className="flex flex-col lg:flex-row  w-11/12 lg:w-9/12 m-auto mt-24 border-2 border-red-900">
        ...
        <div  className="flex flex-col lg:flex-row  w-11/12 lg:w-9/12 m-auto mt-24 border-2 border-red-900">
            ...
            <div className=" flex justify-end items-center lg:w-1/2 h-100">
            <div className="flex flex-col justify-evenly h-4/6 lg:w-5/6 space-y-6">
                    <div className="text-center mt-6 lg:mt-0">
                        <div className="text-5xl">XX99 MARK II</div>
                        <div className="text-5xl">HEADPHONES</div>
