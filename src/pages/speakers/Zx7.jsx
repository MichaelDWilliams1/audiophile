        ...
        <div className=" flex h-100 w-9/12 m-auto">
          <div className=" w-1/2 h-full">
            <img
              ...
              src={siteData[0]?.product[4]?.image.desktop}
            />
          </div>
          <div className=" flex justify-end items-center w-1/2 h-100">
            <div className="flex flex-col justify-between h-4/6 w-5/6">
              ...
              <p className="font-bold">{`$ ${siteData[0]?.product[4]?.price.toLocaleString()}`}</p>
              <div className="flex">
                ...
                <button
                onClick={() => addToCart(siteData[0]?.product[4])}
                  id={siteData[0]?.product[4]?.price}
          ...
          <div className=" flex justify-end w-2/6 h-full">
            <div className=" h-3/4 w-full">
              ...
              <div className=" h-full w-full mt-10 leading-10">
                ...
                <tr>
                  <td className="w-1/4 text-orange-600 font-bold">1x</td>
                  <td className="w-3/4">3.5mm 7.5m Audio Cable</td>
                </tr>
                <tr>
                  <td className="w-1/4 text-orange-600 font-bold">1x</td>
                  <td className="w-3/4">7.5m Optical Cable</td>
                </tr>
              </div>
            </div>
          </div>
      ...
      <section className="w-full h-full flex justify-center items-center ">
        <div className="w-9/12 h-4/6 flex">
          <div className="h-full flex flex-col justify-between w-5/12">
            <div className="imageContainer rounded-xl">
              <img
                ...
                src={siteData[0]?.product[4]?.gallery.first.desktop}
              />
            </div>
            <div className="imageContainer">
              <img
                className="h-full w-full rounded-xl"
                src={siteData[0]?.product[4]?.gallery.second.desktop}
              />
            </div>
          </div>
          <div className="h-full w-7/12">
            <img
              className="h-full w-full rounded-xl"
              src={siteData[0]?.product[4]?.gallery.third.desktop}
            />
          </div>
        </div>
      </section>
